...
@NoArgsConstructor
@Entity
@Table(name = "biological_medicine_plan", schema = "common_medical_history")
public class BiologicalMedicinePlan {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "bio_plan_id")
    ...
    @Column(name = "bio_plan_date")
    @Temporal(TemporalType.DATE)
    private Date bioPlanDate;

    @Column(name = "bio_plan_details")
    @Lob
