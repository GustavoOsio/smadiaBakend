...
@Builder
@Entity
@Table(name = "products_make_detail", schema = "common_financial")
public class ProductsMakeDetail {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "prodct_make_de_id")
    private Long id;
    ...
    @ManyToOne
    @JoinColumn(name = "id_budget",referencedColumnName = "budget_id",insertable = true, updatable = true)
